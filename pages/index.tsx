...
const Home = ({netflixOriginals,
  ...
  return (
    <div className={`relative h-screen bg-gradient-to-b from-gray-900/10 to-[#010511] lg:h-[140vh] ${
      ...
      <div><footer className="bg-[#0d0c0c] text-center lg:text-left drop-shadow-2xl">
        <div className="text-gray-700 text-center p-4 background-color: rgba(0, 0, 0, 0.2);">
          
          <a className="text-white text-lg">© Orange | Made With <a className="animate-pulse">&#129505;</a> By Shavindu Avishka | Dedicated To NSBM Green University - Sri Lanka</a>
          
        </div>
      </footer></div>

      {/* Diaglogflow Inetgration */}
